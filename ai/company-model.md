...
| Field        | Type     | Description |
|--------------|----------|-------------|
| brand        | string   | Commercial brand name (e.g. "ENDAVA") |
| group        | string   | Parent company group (e.g. "ENDAVA Systems") |
...
- **scraperFile**: Full URL to the GitHub Actions workflow (no raw, e.g. `https://github.com/peviitor-scrapers/endava-romania-srl-nodejs-scraper/actions/workflows/job-seeker-ro-spider.yml`)
...
```bash
gh issue list --repo peviitor-scrapers/endava-romania-srl-nodejs-scraper --state open
```
...
- `docs/test-results/index.html` — branding must say "ENDAVA", not the old template

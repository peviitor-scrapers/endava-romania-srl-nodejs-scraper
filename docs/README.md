...
**job_seeker_ro_spider** — scraper pentru job-urile Endava din România.

Extrage anunțurile de pe [Endava Careers](https://www.endava.com/careers) și le publică în [peviitor.ro](https://peviitor.ro) prin API-ul SOLR.
...
3. **Scrape-uiește job-urile** — extrage lista completă de job-uri din API-ul public SmartRecruiters API, filtrat pe România
...
6. **Generează docs/jobs.md** — fișier markdown cu informații companie + toate job-urile curente, publicat pe [GitHub Pages](https://sebiboga.github.io/endava-romania-srl-nodejs-scraper/jobs.md)
...
|---|---|---|
| SmartRecruiters API | `https://api.smartrecruiters.com/...` | Public |
...
# Doar E2E (API real SmartRecruiters + ANAF + SOLR)
npm run test:e2e
```
